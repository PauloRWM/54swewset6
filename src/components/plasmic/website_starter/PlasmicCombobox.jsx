...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 654pDO1ucwDo/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: Ned3svB5HC5Y/css
...
function PlasmicCombobox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tegwi)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__sdgkb)}>
            <ChevronDownIcon
