...
import TextInput from "../../TextInput"; // plasmic-import: zttQRIeaj9UC/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: BQ8-oBRFm1iI/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: cvfg93xi_YFr/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__btAp2, {
          [sty.freeBoxiconEnd__btAp2IAerp]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__btAp2MrWAy]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__btAp2T2FhP]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__bTqqz, {
            [sty.freeBoxiconStart__bTqqzmrWAy]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__bTqqzT2FhP]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vNeK6)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__soAmr, {
            [sty.freeBoxiconEnd__soAmriAerp]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__soAmrmrWAy]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__kDhKk)}
                role={"img"}
              />
            ),
