...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 1sYN4a4fA2hT/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zvtl)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__sxGt6)}>
            <div
              className={classNames(
                projectcss.all,
