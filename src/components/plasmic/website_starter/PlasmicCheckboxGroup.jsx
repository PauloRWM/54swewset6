...
import Checkbox from "../../Checkbox"; // plasmic-import: MZ6R1HQl7OSI/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 3h8zKCI-K9fL/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__b4QY)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___5RNj)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__uubM0)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__hUrZ0)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
