...
import sty from "./PlasmicModal.module.css"; // plasmic-import: GBDCfsUpKJcX/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_IKYeqY0ZvYLb"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___91SMy)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
