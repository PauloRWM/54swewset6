...
import Button from "../../Button"; // plasmic-import: NfzjMgWxp040/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: 8o6gRdMSe_Wv/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_wY22N-xiKegB"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__aqeP5)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__xNw1D)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__e6Qc6)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__xY7Gf)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__hx9KA)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
