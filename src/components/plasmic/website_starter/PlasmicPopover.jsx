...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: N6W9Qkz3jyeB/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: 18_0c6jwq05K/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__baFl1)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__iRxiZ)}
            label={"Open Popover"}
          />
        ),
